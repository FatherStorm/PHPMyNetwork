...
class grocery_CRUD_Model_Driver extends grocery_CRUD_Field_Types
{
	...
	protected function bad_set_ajax_list_queries($state_info = null)
	{
...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	public function where($key, $value = NULL, $escape = TRUE, $dropHaving=false)
	{
		$this->where[] = array($key,$value,$escape, $dropHaving);
	...
	public function get_table()
	{
		...
		elseif( $this->basic_db_table !== null )
		{
			...
			{
				throw new Exception('The table "'.$this->basic_db_table.'"  does not exist. Please check you database and try again.',11);
				die();
			}
